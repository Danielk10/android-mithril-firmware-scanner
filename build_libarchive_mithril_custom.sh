...
# ==========================================
echo "Descargando libarchive para mithril..."
rm -rf "$HOME/libarchive_mithril"
git clone --depth 1 https://github.com/libarchive/libarchive.git "$HOME/libarchive_mithril"

mkdir -p "$HOME/libarchive_mithril/build"
cd "$HOME/libarchive_mithril/build" || exit 1
...
# ==========================================
echo
echo "=== libarchive instalado para mithril ==="
