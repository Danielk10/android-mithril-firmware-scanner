package com.diamon.mithril.utils;
...
public class AssetHelper {
    ...
    private static final String COMPILED_RUNTIME_ROOT = "data/data/com.diamon.mithril/files/usr";
    ...
    public static boolean ensureNativeToolLinks(Context context) {
        ...
        boolean ok = true;
        // Binarios ejecutables de Mithril
        ok &= linkTool(new File(usrBin, "mithril"), new File(nativeLibDir, "libmithril_bin.so"));
