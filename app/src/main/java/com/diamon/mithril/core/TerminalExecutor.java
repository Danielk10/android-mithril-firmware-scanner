...
public class TerminalExecutor {
    ...
    private void runCommand(String commandLine) {
        ...
        if ("./run_mithril.sh".equals(primary) || "run_mithril.sh".equals(primary) || "run_mithril".equals(primary)) {
            tokens[0] = "mithril";
            primary = "mithril";
        }
        ...
        // 2. Ejecucion de binarios nativos (mithril, bsdunzip o rutas de binarios)
