package com.diamon.mithril.ui.activities;
...
import com.diamon.mithril.utils.FileManager;
...
public class MainActivity extends AppCompatActivity implements TerminalExecutor.Callback {
    ...
    private static final String PREFS_NAME = "MithrilPrefs";
    ...
    private Button btnSbom;
    private Button btnCve;
    private Button btnLicenses;
    private Button btnDumpKconfig;
    ...
    private void initViews() {
        ...
        btnSecrets = findViewById(R.id.btnSecrets);
        btnSbom = findViewById(R.id.btnSbom);
        btnCve = findViewById(R.id.btnCve);
        btnLicenses = findViewById(R.id.btnLicenses);
        btnDumpKconfig = findViewById(R.id.btnDumpKconfig);
        btnFetchDb = findViewById(R.id.btnFetchDb);
    ...
    private void setupListeners() {
        ...
        // Acciones nativas de Mithril
        btnScanAll.setOnClickListener(v -> runMithrilAction("-A"));
        btnSecrets.setOnClickListener(v -> runMithrilAction("--secrets"));
        btnSbom.setOnClickListener(v -> runMithrilAction("--sbom"));
    ...
    private void copyLogsToClipboard() {
        ...
        ClipboardManager clipboard = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
        ClipData clip = ClipData.newPlainText("Mithril Logs", text);
        if (clipboard != null) {
