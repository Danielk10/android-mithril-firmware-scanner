...
Paquete: `com.diamon.mithril` (Mithril Firmware Scanner)

Este reporte documenta los archivos y carpetas dentro de `app/src/main/assets/data/data/com.diamon.mithril/files/usr` que no son necesarios para la ejecución de los binarios en la arquitectura arm64-v8a del proyecto Android y que han sido optimizados para reducir significativamente el peso del APK y mejorar el rendimiento de la aplicación.
